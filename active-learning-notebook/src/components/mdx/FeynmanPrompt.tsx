...
export default function FeynmanPrompt({ concept }: FeynmanPromptProps) {
  ...
  return (
    <div className="my-10 bubbly-card bg-neutral-50/50 dark:bg-neutral-900/30 border-neutral-200 dark:border-neutral-700/50">
      ...
      <div className="bg-white dark:bg-[#34302d] p-4 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-inner mb-6">
      ...
      {!submitted ? (
        ...
        <div className="bg-neutral-100 dark:bg-[#403b38] text-neutral-900 dark:text-neutral-100 p-6 rounded-xl animate-in fade-in zoom-in-95 duration-300 space-y-4 border border-neutral-200 dark:border-neutral-700">
          ...
          <button 
            ...
            className="text-sm underline font-bold mt-2 hover:text-neutral-600 dark:hover:text-neutral-400"
          >
            Edit explanation
          </button>
        </div>
