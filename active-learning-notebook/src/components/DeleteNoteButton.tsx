    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-neutral-900/60 backdrop-blur-sm p-4 md:p-6 overflow-y-auto">
          <div className="bg-white dark:bg-[#2d2926] rounded-3xl p-6 md:p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in-95 my-auto">
            ...
            <div className="space-y-3">
              <button 
                onClick={(e) => { e.preventDefault(); handleConfirmDelete(true); }}
              ...
              <button 
                onClick={(e) => { e.preventDefault(); handleConfirmDelete(false); }}
